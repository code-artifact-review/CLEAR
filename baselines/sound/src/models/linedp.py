...
from baselines.sound.src.models.base_model import BaseModel
    ...
    def line_level_prediction(self):
        ...
        for i in range(len(defective_file_index)):
            ...
            for line_index in range(num_of_lines):
                ...
                if defective_file_line_list[line_index].startswith('*') or defective_file_line_list[
                    line_index].startswith('/'):
                    hit_count[line_index] = -1
        ...
        for i in range(len(clean_file_index)):
            ...
            text_to_explain = ' '.join(clean_file_line_list)
            ...
            try:
                ...
                if str(exc) == 'low >= high':
                    print(
                        'Skipping one file because LIME received '
