...
def train_model(which_dataset, dataset_name):
    ...
    for i, train_rel in enumerate(releases[:-1]):
        ...
        for run in range(5):
            ...
            sample_weights = compute_class_weight(class_weight='balanced', classes=np.unique(train_label),
                                                  y=train_label)
